...
void Acc_Initialize(void)
{
    ...
    writeBuffer[3] = 0x00; // 0x22
    writeBuffer[4] = 0x80; // 0x23
    writeBuffer[5] = 0x00; // 0x24
    ...
    writeBuffer[6] = 0x20; // 0x3B
    writeBuffer[7] = 0xf0; // 0x3C
...
void AccRead(void)
{
    ...
    //I2CRead(dataBuffer, 0xa8, 6, LIS2DH12_ADDRESS);
    uint8_t     dataBuffer[1];
    I2CRead(dataBuffer, 0x2a, 1, LIS2DH12_ADDRESS);
}